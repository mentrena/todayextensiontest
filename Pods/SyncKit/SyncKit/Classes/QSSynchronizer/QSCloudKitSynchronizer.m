...
- (NSString *)deviceIdentifier
{
    if (!_deviceIdentifier) {
        ...
        NSUserDefaults *userDefaults = [[NSUserDefaults alloc] initWithSuiteName:self.suiteName];
        _deviceIdentifier = [userDefaults objectForKey:[self userDefaultsKeyForKey:QSCloudKitDeviceUUIDKey]];
        if (!_deviceIdentifier) {
            NSUUID *UUID = [NSUUID UUID];
            _deviceIdentifier = [UUID UUIDString];
            [userDefaults setObject:_deviceIdentifier forKey:[self userDefaultsKeyForKey:QSCloudKitDeviceUUIDKey]];
        }
    }
